...
energyFiles<-allFiles[grep("energyMap_monthly_map_v2", allFiles)] # extract energy files
...
pdf(paste0("/cluster/projects/nn11080k/cfrank93/cbirdEnergy/results/figures/speciesMaps/energy/allBirds_energy_v2.pdf"), width=10, height=7)
