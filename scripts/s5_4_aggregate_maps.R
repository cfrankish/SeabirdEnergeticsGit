...
actSub<-actSub %>%
dplyr::select(species, month, index, NoBirds, timeFlight, timeRestWater, timeLand, timeForage, timeActive, timeTotal, colonies, totalBirds) %>%
dplyr::left_join(actSubWeights, by=c("month"))	
...
# We sum everything together (which will be averaged by total number of birds later... #
actSub2<-actSub2 %>%
dplyr::select(species, month, index, NoBirds, timeFlight, timeRestWater, timeLand, timeForage, timeActive, timeTotal, weight, colonies)
...
pdf(paste0("results/figures/speciesMaps/activity/", energySub$species[1], "_flightMean.pdf"))
plot(flight1)
dev.off()
...
pdf(paste0("results/figures/speciesMaps/activity/", energySub$species[1], "_flightSD.pdf"))
plot(flight2)
dev.off()
...
pdf(paste0("results/figures/speciesMaps/activity/", energySub$species[1], "_RestWaterMean.pdf"))
plot(RestWater1)
dev.off()
...
pdf(paste0("results/figures/speciesMaps/activity/", energySub$species[1], "_RestWaterSD.pdf"))
plot(RestWater2)
dev.off()
...
pdf(paste0("results/figures/speciesMaps/activity/", energySub$species[1], "_LandMean.pdf"))
plot(Land1)
dev.off()
...
pdf(paste0("results/figures/speciesMaps/activity/", energySub$species[1], "_LandSD.pdf"))
plot(Land2)
dev.off()
...
pdf(paste0("results/figures/speciesMaps/activity/", energySub$species[1], "_ForageMean.pdf"))
plot(Forage1)
dev.off()
...
pdf(paste0("results/figures/speciesMaps/activity/", energySub$species[1], "_ForageSD.pdf"))
plot(Forage2)
dev.off()
...
pdf(paste0("results/figures/speciesMaps/activity/", energySub$species[1], "_ActiveMean.pdf"))
plot(Active1)
dev.off()
...
pdf(paste0("results/figures/speciesMaps/activity/", energySub$species[1], "_ActiveSD.pdf"))
plot(Active2)
dev.off()
...
pdf(paste0("results/figures/speciesMaps/activity/", energySub$species[1], "_NoBirds.pdf"))
plot(noBirds)
dev.off()
...
pdf(paste0("results/figures/speciesMaps/activity/", energySub$species[1], "_NoPops.pdf"))
plot(noPops)
dev.off()
...
timeTotal1<-ggplot() +
  ...
  # scale_fill_gradient2('Non-breeding SST (°C)', low = "#364B9A", mid ="white" , high = "#c1121f", midpoint = 10, limits=c(-2.5, 26)) +
  #scale_fill_gradientn('Time spent Active (SD)', colors=c("#364B9A", "#4393C3","#92C5DE", "#D1E5F0", "white", "#FDDBC7", "#F4A582", "#D6604D", "#A50026"), limits=c(min(actSubTotFinal$timeActiveMean), max(actSubTotFinal$timeActiveMean))) +
  scale_fill_gradientn('Total time', colors=c("#364B9A", "#4A7BB7","#6EA6CD", "#98CAE1", "#C2E4EF", "#EAECCC", "#FEDA8B", "#FDB366", "#F67E4B", "#DD3D2D", "#A50026")) +
  #geom_sf(data=allLocations_polygon, aes(color=species), fill=NA) +
  geom_sf(data=world, color = "#E5E5E5", fill = "#E5E5E5") +
  geom_sf(data=coast) +
  coord_sf(crs=projection_NA, xlim=c(min(actMultiPops$x)-400000, max(actMultiPops$x) + 400000), ylim=c(min(actMultiPops$y)-400000, max(actMultiPops$y) + 400000)) +
...
pdf(paste0("results/figures/speciesMaps/activity/", energySub$species[1], "_propTimeMean.pdf"))
plot(timeTotal1)
dev.off()
...
timeTotal2<-ggplot() +
  ...
  # scale_fill_gradient2('Non-breeding SST (°C)', low = "#364B9A", mid ="white" , high = "#c1121f", midpoint = 10, limits=c(-2.5, 26)) +
  #scale_fill_gradientn('Time spent Active (SD)', colors=c("#364B9A", "#4393C3","#92C5DE", "#D1E5F0", "white", "#FDDBC7", "#F4A582", "#D6604D", "#A50026"), limits=c(min(actSubTotFinal$timeActiveMean), max(actSubTotFinal$timeActiveMean))) +
  scale_fill_gradientn('Total time (SD)', colors=c("#364B9A", "#4A7BB7","#6EA6CD", "#98CAE1", "#C2E4EF", "#EAECCC", "#FEDA8B", "#FDB366", "#F67E4B", "#DD3D2D", "#A50026")) +
  #geom_sf(data=allLocations_polygon, aes(color=species), fill=NA) +
  geom_sf(data=world, color = "#E5E5E5", fill = "#E5E5E5") +
  geom_sf(data=coast) +
  coord_sf(crs=projection_NA, xlim=c(min(actMultiPops$x)-400000, max(actMultiPops$x) + 400000), ylim=c(min(actMultiPops$y)-400000, max(actMultiPops$y) + 400000)) +
...
pdf(paste0("results/figures/speciesMaps/activity/", energySub$species[1], "_propTimeSD.pdf"))
plot(timeTotal2)
dev.off()
