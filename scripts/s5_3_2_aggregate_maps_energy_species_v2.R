...
dplyr::summarise(energyPopkJ_mean=sum(energyPopkJ_mean), energyPopkJ_sd=mean(energyPopkJ_sd), energyPopkJ_se=mean(energyPopkJ_se), NoBirds_mean=sum(NoBirds_mean), DEEkJ_mean=sum(DEEkJ_mean, na.rm=TRUE))
