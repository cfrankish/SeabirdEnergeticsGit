...
c(0), c(1.00, 0.96, 1.04), c(0), c(0), c(0), c(0), # RMR is just for a few of the species...BlKi / NoFu (Resting metabolic rate)
c(3.88, 2, 5.7), c(2.2, 2.2-2.2*0.1, 2.2+2.2*0.1), c(141, 106, 176), c(8.44, 5.4, 11.5), c(141, 106, 176), c(141, 106, 176), # c1 is the cost of Flight
list(c(2.06, 3.88) ,c(0.3, 2),c(3.8, 5.7)), list(c(2.06, 3.88) ,c(0.3, 2),c(3.8, 5.7)), c(0), c(0), c(0), c(0), # c2 is the cost of foraging...
c(0.56, 0.05, 1.1), c(0.8, 0.8-0.8*0.1, 0.8+0.8*0.1), c(9.2, 3.1, 15.3), c(9.2, 3.1, 15.3), c(9.2, 3.1, 15.3), c(9.2, 3.1, 15.3), # c3 is cost of being on land...
c(1.24, 0.1, 2.8), c(2, 2-2*0.1, 2+2*0.1), c(9.2, 3.1, 15.3), c(9.2, 3.1, 15.3), c(9.2, 3.1, 15.3), c(9.2, 3.1, 15.3), # c4 is the cost of resting on the water...
